package com.maxsasha.services.second.redirector;
...
public class RedirectorToSecondService {
    ...
    public Student redirectToCreate(StudentDto dto) throws JsonProcessingException {
    ...
    public Student redirectToUpdate(StudentDto dto) throws JsonProcessingException {
        headers.setContentType(new MediaType("application", "json"));
        HttpEntity<String> requestEntity = new HttpEntity<String>(mapper.writeValueAsString(dto), headers);
        return restTemplate
